				...
				<div class="col-md-9 col-sm-12 col-12 wrapper">
						<div class="row">
								<div class="col-md-12">
										...
										<div class="jumbotron jumbotron-category">
												<h3>Ofertas </h3>
												<p>Discubre nuestras ofertas de movilelx </p>
										</div>
										<div class="col-md-12">
                      ...
                      ?>
								...
								<div class="col-md-12 col-sm-12 col-12">
										<div class="row">
                      <?php
                      $num_product_database = $producto_manager->countOfertas();

                      $url = 'ofertas.php?a=a';
                      $page = (isset($_GET['page']) && !empty($_GET['page']) && $_GET['page'] > 0 ? intval($_GET['page']) : 1);
                      $pagination = new \App\Pagination($page,$num_product_database,5);
                      $prod = $producto_manager->getOfertas($pagination->offset(),$pagination->getRecordsPerPage());
                      ...
                      <?php if(count($prod) > 0):?>
                        <?php foreach ($prod as $products):?>
                                            ...
                                            <?php endif;?>
																							...
																							<p>
																									<a href="verproducto.php?id=<?= $products->id ?>&cat=<?= 2 ?>" class="btn btn-movilex  btn-success "> Ver</a>

																									<a href="addcard.php?product_id=<?= $products->id ?>&cat=<?= 2 ?>" class="btn btn-default add-to-cart btn-movilex"> <i class="fa fa-shopping-cart"></i> Añadir</a>
