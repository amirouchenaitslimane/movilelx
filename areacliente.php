...
?>
		<tr>
		<td><?= htmlspecialchars(trim($linea->nombre)) ?></td>
		<td><?= htmlspecialchars(trim($linea->precio)) ?>€</td>
		<td><?= htmlspecialchars(trim($linea->cantidad)) ?></td>
		<td class="pull-right"><?= htmlspecialchars(trim($linea->precio_compra)) ?> €</td>
		</tr>
<?php
endforeach;
?>
		...
		<td></td>
		<td></td>
		<td class="pull-right" align="right"><strong><?= trim($linped_manager->TotalPrecioCompra($pedido->getId())->total) ?> €</strong></td>
		</tr>
		<tr>
		<td><strong>IVA (<?= (\app\Cart::_IVA*100)?> %)</strong></td>
		<td></td>
		<td></td>
		<td class="pull-right" align="right"><strong><?= trim($linped_manager->TotalPrecioCompra($pedido->getId())->total*\app\Cart::_IVA) ?> €</strong></td>
		</tr>
		</tbody>
		<tfoot>
		<tr>
		...
		<td></td>
		<td></td>
		<td class="pull-right" align="right"><strong><?= (trim($linped_manager->TotalPrecioCompra($pedido->getId())->total) + ($linped_manager->TotalPrecioCompra($pedido->getId())->total * \app\Cart::_IVA)); ?> €</strong></td>
		</tr>
		</tfoot>
</table>
