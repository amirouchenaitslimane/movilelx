            ...
            <div class="card card-form  ">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs mt-3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="#teste" role="tab" data-toggle="tab">Teste</a>
                    ...
                    <div class=" tab-content ">
                       ...
                       <div role="tabpanel" class="tab-pane fade in  " id="teste">
                           ...
                           <div class="card">
                               ...
                               <div class="card-body">
                                   <div class="row">
                                       <div class="col-md-6 col-12 col-sm-6">
                                           <p class="text-primary">Nombre: <strong class="text-dark"><?= $user->getNombre(); ?></strong></p>
                                           <p class="text-primary" >Apeilldo: <strong class="text-dark"><?= $user->getApellido(); ?></strong></p>
