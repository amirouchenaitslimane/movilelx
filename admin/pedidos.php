                ...
                ?>
                        ...
                        <?php foreach ( $pedidos as $pedido):?>
														<tr>
																...
																<td ><p class="bg-<?=$pedido->estado ?>"><?= \app\Pedido::getEstadoOption()[$pedido->estado] ?></p></td>

																<td>

																		<a href="pedidodetail.php?id=<?= $pedido->id ?>" class="btn btn-primary"> <i class="fa fa-eye"></i></a>
																</td>
														</tr>
                        <?php endforeach;?>
												</tbody>
